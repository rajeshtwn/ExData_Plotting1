plot4 <- function() {
	...
	if(file.exists(data_file)) {
		...
		# First plot
		plot(new_data$timestamp, as.numeric(as.character(new_data$Global_active_power)), type="l", xlab="", ylab="Global Active Power")
		
		# Second plot
		plot(new_data$timestamp, as.numeric(as.character(new_data$Voltage)), type="l", xlab="datetime", ylab="Voltage")
		...
		# Fourth plot
		plot(new_data$timestamp, as.numeric(as.character(new_data$Global_reactive_power)), type="l", xlab="datetime", ylab="Global_reactive_power")
